...
async function main() {
    const defaultPasswordHash = await bcryptjs_1.default.hash('123456', 10);
            ...
            for (let slotIndex = 0; slotIndex < route.departureSlots.length; slotIndex += 1) {
                ...
                const trip = await prisma.trip.create({
                    data: {
                        ...
                        departureTime,
                        arrivalTime,
                        price: new decimal_js_1.default(route.basePrice),
    ...
    const carriagesByTrainId = new Map();
    ...
    const pickSeats = (trainId, offset, count) => {
